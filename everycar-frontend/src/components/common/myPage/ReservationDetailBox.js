        ...
        <div>
                ...
                <div className={styles.reservationCarInfo}>
                    ...
                    <div className={styles.rentalInfo}>
                        <div className={styles.carTitle}>
                            <p className={styles.carName}>{reservationData.modelName || "모델명 없음"}</p>
                            <span className={styles.grade}>{reservationData.carGrade || "등급 정보 없음"}</span>
                        </div>
                        <div>
                            <table>
                                <tbody>
            ...
            <div className={styles.reservationHistoryBox}>
                ...
                <div className={styles.rentalLocation}>
                    <h3>대여 장소</h3>
                    <div>
                        <div>{reservationData.rentalLocationName || "알 수 없음"}</div>
                    </div>
                </div>
